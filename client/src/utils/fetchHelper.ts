...
export const apiFetch = async (input: RequestInfo | URL, init?: RequestInit): Promise<Response> => {
  ...
  try {
    ...
    // If it succeeds (e.g. status isn't 404), make sure it's valid JSON from our backend.
    // This avoids localtunnel warning pages or CDN 404 page content-types (HTML) from causing JSON syntax errors.
